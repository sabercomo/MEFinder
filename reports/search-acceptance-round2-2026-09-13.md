...
- **服务器级基准:normal(搜索)场景已跑**(见"附",逐查询 p50 坐实"社会"联合请求 ~2.4 s)。**完整三轮四场景已跑**(2026-09-13,模型就位,见 [四场景报告](performance-real-4scenario-2026-09-13.md)):四场景全 0 错误、0 次 503、对齐期间 343 重叠搜索全 200;工具 `--compare` 因严格有效性门(export 轮偶发覆盖 7/8)中止,503 二值对比(28.2%→0)直接成立。
