...
事实：导论规则把英文版《消费社会》的编者导论也纳入正文，其自带的 References 又截断了全书正文（`[42,584)`）。现规定：首章前的导论如在首章前带有自己的参考文献表，视为编者导论排除；只带注释的作者导论仍算正文。本文的作者导论样例不受影响（回归测试仍通过）。详见 [正文范围塌缩](alignment-body-range-collapse.md)。
