...
<p align="center"><strong>记得一句话，却忘了它在哪本书、哪一页？</strong></p>

<p align="center">MEFinder 帮你回到原文。</p>
...
我是一名在读文科硕士生。写大论文时，我常常要在多个 PDF 之间来回切换：明明记得一句话，却忘了它在哪篇文献、哪一页；在这一本里搜不到，就关掉，再打开下一本，反复搜索、核对和翻页。

就是在这些重复操作里，我开始想：如果有一个工具，能把自己的文献放在一起，只凭一句原文或一个片段，就找回出处、上下文和页码，会不会省下很多时间？
