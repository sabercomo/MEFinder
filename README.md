...
<p align="center"><strong>论文定稿前，让每一句引文都能回到原文。</strong></p>

<p align="center">MEFinder 帮你核对出处、上下文和页码。</p>
...
我是一名在读文科硕士生。大论文快要定稿时，我需要把正文里的引文一条条重新核对：原文有没有抄错，出处有没有写对，页码是否准确，对上下文的理解有没有偏差。

为了确认这些内容，我常常要在多个 PDF 之间来回切换，反复打开、搜索、翻页，再回到论文里修改。就是在这一轮轮核对中，我开始想：如果有一个工具，能把自己的文献放在一起，只要粘贴论文中的引文，就能找到对应原文、上下文和页码，会不会省下很多时间，也少一些定稿时的不安？
