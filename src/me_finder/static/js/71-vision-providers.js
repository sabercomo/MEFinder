/* IIFE 包裹：远程视觉供应商与导入页供应商选择保持私有。
   模块间调用统一走 MEFinder.visionProviders；只有内联处理器显式挂到全局。 */
(function (global) {  // module: 71-vision-providers.js
  ...
  function handleVisionBaseInput() {
    autoFillVisionName();
    visionBaseActiveIndex = -1;
    visionBaseShowAll = false;
    openVisionBasePop();
  ...
  function handleVisionModelInput() {
    visionModelActiveIndex = -1;
    openVisionModelPop();
  }
  ...
  var visionProvidersAPI = {
    ...
    positionImportMenu: positionImportVisionMenu,
    handleBaseInput: handleVisionBaseInput,
    handleModelInput: handleVisionModelInput,
    maybeAutoFetchModels: maybeAutoFetchVisionModels,
    openBasePopup: openVisionBasePop,
    closeBasePopup: closeVisionBasePop,
    baseKeydown: visionBaseKeydown,
    pickBase: pickVisionBase,
    openModelPopup: openVisionModelPop,
    closeModelPopup: closeVisionModelPop,
    modelKeydown: visionModelKeydown,
    pickModel: pickVisionModel,
    updateEditorHead: updateVisionEditorHead
  };
  ...
  if (typeof module !== "undefined" && module.exports) {
    Object.assign(module.exports, {
      hideVisionPop: hideVisionPop,
      revealVisionPop: revealVisionPop,
      setVisionNameAutoValue: function (value) { visionNameAutoValue = value; }
    });
  }
