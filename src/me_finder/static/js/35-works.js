...
(function (global) {  // module: 35-works.js
  ...
  function openBodyRangeDialog(group, a, b) {
    return global.MEFinder.workRange.open({
      works: works, rangeDraftKey: rangeDraftKey, pivotFor: pivotFor,
      openDialog: openDialog, el: el, button: button,
      canGenerate: canGenerate, generateBlockedReason: generateBlockedReason,
      memberName: memberName, sourceTitle: sourceTitle, languageName: languageName,
      requestJSON: requestJSON, postJSON: postJSON, closeDialog: closeDialog, startJob: startJob
    }, group, a, b);
  }
