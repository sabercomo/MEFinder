...
class MCPPackagingTests(unittest.TestCase):
    ...
    def test_sidecar_is_an_independent_console_onefile_build(self) -> None:
        ...
        self.assertIn("v0.5.1-mcp-v1-tools.json", self.sidecar_spec)
    ...
    def test_windows_hosted_release_gate_covers_distribution_lifecycle(self) -> None:
        ...
        self.assertIn("MEFinder-v0.5.1-windows-setup.exe", self.windows_workflow)
        self.assertIn("MEFinder-v0.5.1-windows-portable.zip", self.windows_workflow)
