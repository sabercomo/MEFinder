...
const context = {module:{exports:{}}, MEFinderActions:{register(){},registerInline(){}}, libraryStore:{sources:[{source_file_id:'pdf',source_type:'pdf'}, {source_file_id:'epub',source_type:'word'}]},
